...
public class GetS3ObjectSample {
     ...
     */
    public static void getS3Object(String endPoint, String bucketName, String regionName, String awsAccessKey, String awsSecretKey) {
        System.out.println("*******************************************************");
        ...
        try {
            ...
            //endpointUrl = new URL("http://" + bucketName + ".s3.amazonaws.com/ExampleChunkedObject.txt");
