    ...
    public static void getPresignedUrlToS3Object(String bucketName, String regionName, String awsAccessKey, String awsSecretKey) {
        ...
        try {
            if (regionName.equals("us-east-1")) {
                endpointUrl = new URL("http://s3.amazonaws.com/" + bucketName + "/ExampleObject.txt");
            } else {
                endpointUrl = new URL("http://s3-" + regionName + ".amazonaws.com/" + bucketName + "/ExampleObject.txt");
            }
