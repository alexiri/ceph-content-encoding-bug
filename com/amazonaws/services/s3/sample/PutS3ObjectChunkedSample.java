...
public class PutS3ObjectChunkedSample {
     ...
     */
    public static void putS3ObjectChunked(String endPoint, String bucketName, String regionName, String awsAccessKey, String awsSecretKey) {
        System.out.println("***************************************************");
        ...
        URL endpointUrl;
        try {
            endpointUrl = new URL(endPoint + "/" + bucketName + "/ExampleChunkedObject.txt");
            //if (regionName.equals("us-east-1")) {
            //    endpointUrl = new URL("http://s3.amazonaws.com/" + bucketName + "/ExampleChunkedObject.txt");
            //} else {
            //    endpointUrl = new URL("http://s3-" + regionName + ".amazonaws.com/" + bucketName + "/ExampleChunkedObject.txt");
            //}
